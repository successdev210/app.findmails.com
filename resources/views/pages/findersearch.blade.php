    ...
    <div class="side__box history" style="display:none;">
        ...
        <div class="list__campaigns campaigns__v--placeholder" style="overflow-y:hidden;">
            ...
            <div class="finder__list">
                <div class="elem__finder">
                    <p><span class="tooltip__float" data-tooltip="Email verified."><img src="img/success.svg"
                                alt="success"></span> gordin@facebook.com</p>
                    <div class="controls__">
                        <a href="#" class="tooltip__float copy__button--email" data-tooltip="Copy"
                            data-copy="SOME COPIED TEXT"><svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                        ...
                        <a href="#" class="tooltip__float" data-tooltip="Add to Leads"><svg width="16" height="16"
                ...
                <div class="elem__finder">
                    <p><span class="tooltip__float" data-tooltip="Email verified."><img src="img/success.svg"
                                alt="success"></span> sam@facebook.com</p>
                    <div class="controls__">
                        <a href="#" class="tooltip__float copy__button--email" data-tooltip="Copy"
                            data-copy="SOME COPIED TEXT"><svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
        ...
        <form action="" class="finder__search">
            ...
            <div class="head__verification">
                ...
                <div class="controls__button">
                    <a href="#" class="outline-btn history__domain"><span><img src="img/history.svg"
            ...
            <div class="search__field">
                <div class="group__input">
                    <div class="finder__input group__input">
                        <input type="text" placeholder="First name" class="first-name" value="">
                        <input type="text" placeholder="Last name" class="last-name" value="">
                        <input type="text" placeholder="Company" class="company" value="">
                    </div>
